...
import { BookSummary } from '@/lib/book-summary-schema';

export function generateObsidianURI(bookData: BookSummary, vaultName: string = "MyVault") {
  const tags = ["Study", bookData.dynamic_tags?.category || "Literature", bookData.dynamic_tags?.origin || "Western"];
